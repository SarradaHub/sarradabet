...
import adminPixPaymentsRoutes from "../modules/admin/routes/admin.payments.routes";
...
router.use("/admin/payments/pix", adminPixPaymentsRoutes);
...
router.get("/", (req, res) => {
  res.json({
    ...
    endpoints: {
      ...
      adminPixPayments: "/api/v1/admin/payments/pix",
