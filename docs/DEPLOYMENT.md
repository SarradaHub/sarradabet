...
services:
  ...
  api:
    ...
    environment:
      ...
      PIX_EXPIRATION_MINUTES: ${PIX_EXPIRATION_MINUTES:-30}
    ports:
      - "8000:8000"
    depends_on:
      postgres:
